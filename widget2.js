...
.bottlr-widget-card { width:30vw; height:600px; display:flex; flex-direction:column; background:linear-gradient(to bottom,#ecfdf5,#ffffff); box-shadow:0 8px 24px rgba(0,0,0,0.2); border-radius:.5rem; overflow:hidden; }
