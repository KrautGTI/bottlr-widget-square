// widget34.js - Bottlr Widget with Socket.IO
// Prerequisites: Socket.IO, React, ReactDOM, Lucide Icons, and Marked must be loaded
// Add these to your HTML before this script:
...
(async function() {
    ...
    if (typeof io === 'undefined') {
        console.error('❌ Socket.IO client not found. Please include Socket.IO before this script.');
        return;
    }

    // Check if React is available
    if (typeof React === 'undefined' || typeof ReactDOM === 'undefined') {
        console.error('❌ React not found. Please include React and ReactDOM before this script.');
        return;
    }
    ...
    const lucideModule = await import('https://esm.sh/lucide-react@0.263.0?bundle');
    const { MessageCircle, Send, X, Wine } = lucideModule;
    ...
    // React components using UMD build
    ...
    function ProductCard({ category, imageUrl, name, price, url, buttonText = "Add to Cart" }) {
        ...
        return h("div", { className: "bottlr-product-card" },
            category && h("div", { className: "bottlr-product-category" }, category),
            imageUrl && h("img", { src: imageUrl, alt: name, className: "bottlr-product-image" }),
            name && h("div", { className: "bottlr-product-name" }, name),
            h("button", { className: "bottlr-product-button", onClick: handleProductClick },
    ...
    function TypingIndicator() {
        return h("div", { className: "bottlr-typing" },
            h("span", { style: { fontSize: "14px", color: "#666", marginRight: "8px" } }, "Typing"),
            h("div", { className: "bottlr-typing-dots" },
                h("div", { className: "bottlr-typing-dot" }),
                h("div", { className: "bottlr-typing-dot" }),
                h("div", { className: "bottlr-typing-dot" })
            )
        );
    ...
    function ChatInterface() {
        ...
        return h(Fragment, null,
            h("div", { className: "bottlr-widget-msgs" },
                messages.map(msg => {
                    ...
                    return h("div", { key: msg.id, className: `bottlr-msg ${msg.type}` },
                        msg.type === "bot" && h("div", { className: "bottlr-msg-header" },
                            h("div", { className: `bottlr-avatar ${msg.type}` }, "b"),
                            h("span", { 
                        ...
                        msg.type === "bot" 
                            ...
                            : h("div", { className: "bottlr-msg-content" }, msg.content),
                        responseData.productInfo && h(ProductCard, {
                        ...
                        msg.options && h("div", { className: "bottlr-options" },
                            msg.options.map((option, idx) => 
                                ...
                                h(Wine, { size: 18, color: "#ffffff" }),
                                option)
                            )
                        )
                    );
                }),
                isTyping && h("div", { className: "bottlr-msg bot" },
                    h("div", { className: "bottlr-msg-header" },
                        h("div", { className: "bottlr-avatar bot" }, "b"),
                        h("span", { 
                            style: { fontSize: "14px", fontWeight: "600", color: "#1a1a1a" }
                        }, "Bottlr")
                    ),
            ...
            h("div", { className: "bottlr-input-area" },
                h("div", { className: "bottlr-input-container" },
                    h("textarea", {
    ...
    function ChatWidget() {
        ...
        return h(Fragment, null,
            ...
            }, h(MessageCircle, { size: 28, color: "#fff" })),
            isOpen && h("div", { className: "bottlr-widget-card" },
                h("div", { className: "bottlr-widget-header" },
                    h("h3", null, 
                        h(Wine, { size: 20 }), "Bottlr"
                    ),
                    h("button", {
    ...
    ReactDOM.render(h(ChatWidget), root);
